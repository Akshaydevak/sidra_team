...
class CreateNewTask extends StatefulWidget {
  ...
  final bool editTask;
  const CreateNewTask({Key? key,  this.isSubTask=false,  this.editTask=false}) : super(key: key);
...
class _CreateNewTaskState extends State<CreateNewTask> {
                              ...
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child:  TextFormField(
                                          ...
                                          decoration: InputDecoration(hintText: "Enter Discription",border: InputBorder.none),
                                        )
                                      )
                                    ],
                                  ),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                            ...
                                                            content: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                GestureDetector(
                                                                  ...
                                                                  child: Container(
                                                                    height: 25,width: 75,color: ColorPalette.primary,
                                                  ...
                                                  child: Text(
                                                    widget.editTask?startstdDate:_range2.isNotEmpty? startDate2:"Choose Date",
                                                    style: GoogleFonts.roboto(
                                                ...
                                                GestureDetector(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    widget.editTask?startTime:"${_time.hour}"":""${_time.minute} ${_time.period.name}"??"",
                                                    style: GoogleFonts.roboto(
                                                      color: Color(0xfffe5762),
                                                      fontSize: 18,
                                                      fontWeight: FontWeight.w500,
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                 widget.editTask?endstdDate: _range2.isNotEmpty?ebdDate2:"Choose Date",
                                                  style: GoogleFonts.roboto(
                                                    color: Color(0xfffe5762),
                                                    fontSize: 18,
                                                    fontWeight: FontWeight.w500,
                                                ...
                                                GestureDetector(
                                                  ...
                                                  child: Text(
                                                    // widget.edit?endTime:
                                                    widget.editTask?endTime:"${_time2.hour}"":""${_time2.minute} ${_time2.period.name}"??"",
                                                    style: GoogleFonts.roboto(
                                                      color: Color(0xfffe5762),
                                                      fontSize: 18,
                                                      fontWeight: FontWeight.w500,
                                    ...
                                    child:  SingleRow(
                                        ...
                                        endIcon: Row(
                                          children: [
                                            ...
                                            PriorityLeval==""?Icon(Icons.arrow_forward_ios_sharp):Container()
                                          ],
                                        )),
                                  ),
                                ),SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            child: taskListNew.isEmpty?Container():Container(
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              ...
                                              Variable.taskIdForSubtask=int.tryParse(taskId!)??0;
                                ...
                                GestureDetector(
                                  onTap: (){
                                    ...
                                    PersistentNavBarNavigator.pushNewScreen(
                                      context,
                                      screen: ReportingPerson(editTask: false,readTask: readTask,task: true,job: false,),
                                      withNavBar: true, // OPTIONAL VALUE. True by default.
                                      pageTransitionAnimation: PageTransitionAnimation.fade,
                                    ):
                                    PersistentNavBarNavigator.pushNewScreen(
                                      context,
                                      screen: ReportingPerson(editTask: true,readTask: readTask,task: true,job: false,),
                                      withNavBar: true, // OPTIONAL VALUE. True by default.
                                      pageTransitionAnimation: PageTransitionAnimation.fade,
                                    );
                                  },
                                ...
                                Container(
                                  ...
                                  child: AddText(label: "Add Notes",controller: notesController,
                                ...
                                Container(
                                  ...
                                  child: AddText(label: "Add Remarks",controller: remarksController,
                                      hint: "Enter Remarks",isActive: remarksController.text==""?false:true),
                                ),
                                SizedBox(
                                  height: 10,
                                ),
  ...
  _showModalBottomSheet(BuildContext context,List<GetTaskTypeList> taskTypeList) {
