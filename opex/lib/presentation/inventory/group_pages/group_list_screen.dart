...
class _GroupListScreenState extends State<GroupListScreen> {
  ...
  @override
  void initState() {
    context.read<InventoryBloc>().add(const GetGroupListEvent('', "", ""));
      ...
      listener: (context, state) {
        if (state is DeleteGroupSuccess) {
          showSnackBar(context,
              message: "Group Successfully Deleted", color: ColorPalette.green);
          context
              .read<InventoryBloc>()
              .add(const GetGroupListEvent('', '', ''));
        }
                  ...
                  children: [
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteGroupEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
                        ...
                        if (state is GetGroupListFailed) {
                          // group.clear();
                          division.clear();
                          // setState(() {});
