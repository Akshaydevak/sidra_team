...
import 'create_uom_group_screen.dart';

class UomGroupListScreen extends StatefulWidget {
  const UomGroupListScreen({Key? key}) : super(key: key);

  @override
  State<UomGroupListScreen> createState() => _UomGroupListScreenState();
}

class _UomGroupListScreenState extends State<UomGroupListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<InventoryBloc, InventoryState>(
      listener: (context, state) {
        if (state is DeleteUomGroupSuccess) {
          showSnackBar(context,
              message: "Uom Group Successfully Deleted",
              color: ColorPalette.green);
          context
              .read<InventoryBloc>()
              .add(const GetUomGroupListEvent('', '', ''));
        }
        if (state is DeleteUomGroupFailed) {
          showSnackBar(context,
                  ...
                  children: [
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "Are You Sure To Delete The Uom Group..?",
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteUomGroupEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
                        ...
                        if (state is GetUomGroupListFailed) {
                          division.clear();
                        }
