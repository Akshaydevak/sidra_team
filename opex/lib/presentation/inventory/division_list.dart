...
class _DivisionListScreenState extends State<DivisionListScreen> {
  ...
  void initState() {
    division.clear();
    context.read<InventoryBloc>().add(const GetDivisionListEvent('', '', ''));
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<InventoryBloc, InventoryState>(
      listener: (context, state) {
        ...
        if (state is DeleteDivisionLoading) {
          showSnackBar(context,
              message: "Division Deletion Loading", color: ColorPalette.green);
        }
        if (state is DeleteDivisionSuccess) {
          showSnackBar(context,
              message: "Division Successfully Deleted",
              color: ColorPalette.green);
          context
              .read<InventoryBloc>()
              .add(const GetDivisionListEvent('', '', ''));
        }
        if (state is DeleteDivisionFailed) {
          showSnackBar(context,
                  ...
                  children: [
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "Are You Sure To Delete The Division..?",
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteDivisionEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
                        ...
                        if (state is GetDivisionListFailed) {
                          division.clear();
                        }
