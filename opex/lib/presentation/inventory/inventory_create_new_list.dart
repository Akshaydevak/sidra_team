...
import '../seller_app/add_new_list.dart';
...
class InventoryCatProductCard extends StatefulWidget {
  ...
  const InventoryCatProductCard({
    Key? key,
    this.division,
  }) : super(key: key);

  @override
  State<InventoryCatProductCard> createState() => _CatProductCardState();
}

class _CatProductCardState extends State<InventoryCatProductCard> {
  bool isSelect = false;
