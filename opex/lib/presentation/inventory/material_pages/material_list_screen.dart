    ...
    return BlocListener<InventoryBloc, InventoryState>(
      listener: (context, state) {
        if (state is DeleteMaterialSuccess) {
          ...
          context
              .read<InventoryBloc>()
              .add(const GetMaterialListEvent('', '', ''));
        }
        if (state is DeleteMaterialSuccess) {
          showSnackBar(context,
                  ...
                  children: [
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteMaterialEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
                        ...
                        if (state is GetMaterialListFailed) {
                          // group.clear();
                          division.clear();
                          // setState(() {});
