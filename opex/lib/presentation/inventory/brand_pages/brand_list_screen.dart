      ...
      listener: (context, state) {
        if (state is DeleteBrandLoading) {
          showSnackBar(context,
              message: "Brand Deletion Loading", color: ColorPalette.green);
        } else if (state is DeleteBrandSuccess) {
          showSnackBar(context,
              message: "Brand Deleted Successfully", color: ColorPalette.green);
          context
              .read<InventoryBloc>()
              .add(const GetBrandListEvent('', '', ''));
        } else if (state is DeleteBrandFailed) {
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    SearchCard(
                      hint: "Search Your Brand...!",
                      onchange: (jj) {
                        context
                            .read<InventoryBloc>()
                            .add(GetBrandListEvent(jj ?? "", '', ''));
                        setState(() {});
                      },
                    ),
                    SizedBox(
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                        ...
                        if (state is GetBrandListFailed) {
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "Are You Sure To Delete The Brand..?",
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteBrandEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
