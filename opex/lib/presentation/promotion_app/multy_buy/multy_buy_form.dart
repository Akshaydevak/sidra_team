...
class MultyBuyFormOne extends StatefulWidget {

  final String? restorationId;
  MultyBuyFormOne({Key? key,this.restorationId}) : super(key: key);

  @override
  State<MultyBuyFormOne> createState() => _NewPromotionState();
}

class _NewPromotionState extends State<MultyBuyFormOne> with RestorationMixin {
