...
class _NewPromotionState extends State<PromotionSaleForm> with RestorationMixin {
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: basedOn.map<DropdownMenuItem<String>>((String _value) =>
                                  ...
                                  CustomCheckBox(
                                    ...
                                    onChange: (p0) {
                                      ...
                                      if (p0) {
                                        ...
                                        segmentListttt.remove(segmentList[index].name ?? "");
                              ...
                              itemBuilder: (context, index) => Row(
                                children: [
                                  CustomCheckBox(
                                    ...
                                    value:
                                    // widget.readUser,
                                    availableCustomerList.contains(customerList[index].name),
                                    onChange: (p0) {

                                      if (p0) {
                                        availableCustomerList.add(
                                            GetTypeApplying(customerGroupId: customerList[index].code,
                                              customerGroupCode: customerList[index].code,));

                                      }
                                      else {
                                        availableCustomerList.remove(GetTypeApplying(customerGroupId: customerList[index].code,
                                          customerGroupCode: customerList[index].code,));
                                      }
                                      // widget.listuser(widget.userList);
                                      print("customer list${availableCustomerList}");
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              edit?fromDate??"":_range.isEmpty?"Choose Date":_range.split(" - ")[0],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            edit?toDate??"": _range.isEmpty?"Choose Date":_range.split(" - ")[1],
                            textAlign: TextAlign.right,
                            style: GoogleFonts.roboto(
                              color: Color(0xff797979),
                              fontSize: w/22,
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              edit?fromTime??"":"${_time.hour}"":""${_time.minute} ${_time.period.name}"??"",
                              textAlign: TextAlign.right,
                              style: GoogleFonts.roboto(
                                color: Color(0xff797979),
                                fontSize: w/22,
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              edit?toTime??"":"${_time.hour}"":""${_time.minute} ${_time.period.name}"??"",
                              textAlign: TextAlign.right,
                              style: GoogleFonts.roboto(
                                color: Color(0xff797979),
                                fontSize: w/22,
                          ...
                          onPressed: () {
                            edit? BlocProvider.of<DiscountBloc>(context).add(
                                UpdateOfferPeriodEvent(
                                    ...
                                    fromTime: fromTime==""?"${_time.hour}"":""${_time.minute} ${_time.period.name}":fromTime.toString(),
                                    note: note.text,
                                    title: title.text,
                                    toDate: toDate==""?_range.split(" - ")[1]:toDate.toString(),
                                    toTime: toTime==""?"${_time.hour}"":""${_time.minute} ${_time.period.name}":toTime.toString(),
                                    fromDate: fromTime==""?_range.split(" - ")[0]:fromTime.toString()
                                )):BlocProvider.of<DiscountBloc>(context).add(
                                CreateOfferPeriodEvent(
                                    isActive: true,
                                    createdBy: authentication.authenticatedUser.code,
                                    description: discription.text??"",
                                    fromTime: "${_time.hour}"":""${_time.minute} ${_time.period.name}"??"",
                                    note: note.text,
                                    title: title.text,
                                    toDate: _range.split(" - ")[1],
                                    toTime: "${_time.hour}"":""${_time.minute} ${_time.period.name}"??"",
                      ...
                      edit? GradientButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<DiscountBloc>(context).add(
                                DeleteOfferPeriodEvent(offerperiodRead?.id??0));
                          },
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      onselect(index);
                                      setState(() {});
                                      offerperiodId=offerPeriodList[index].id??0;
                                      offerPeriodName=offerPeriodList[index].title??"";
                                      Navigator.pop(context);
                                    },
                                    child: Container(
                                      padding: const EdgeInsets.only(
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      context.read<DiscountBloc>().add( GetOfferPeriodReadEvent(offerPeriodList[index].id??0));
                                      _showModalBottomSheetNew(context,true);
                                    },
                                    child: Text("View",style: TextStyle(fontWeight: FontWeight.w500,
                                        color: ColorPalette.primary,fontSize: w/24),),
                                  )
                                ],
                              ),
                              separatorBuilder: (context, index) => Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      onselect(index);
                                      setState(() {});
                                      offergroupId=offergroupList[index].id??0;
                                      discountChannelCode=offergroupList[index].channelCode??"";
                                      offerGroupName=offergroupList[index].title??"";
                                      Navigator.pop(context);
                                    },
                                    child: Container(
                                      padding: const EdgeInsets.only(
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      Variable.offerGroupId=offergroupList[index].id??0;
                                      print("OFFFER${Variable.offerGroupId}");
                                      context.read<DiscountBloc>().add(GetOfferGroupReadEvent(offergroupList[index].id??0));
                                      setState((){});
                                      _showModalBottomSheetGroupCreate(context,true);
                                    },
                                    child: Text("View",style: TextStyle(fontWeight: FontWeight.w500,
                                        color: ColorPalette.primary,fontSize: w/24),),
                                  )
                            ...
                            GradientButton(
                                color: ColorPalette.primary,
                                onPressed: () {
                                  _showModalBottomSheetGroupCreate(context,false);
                                },
                                gradient: const LinearGradient(
                                    begin: Alignment.topCenter,
                                    end: Alignment.bottomCenter,
                  ...
                  child: Column(
                    children: [
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      items: channelList
                                          .map<DropdownMenuItem<String>>((ChannelList _value) =>
                                          DropdownMenuItem<String>(
                      ...
                      edit? GradientButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<DiscountBloc>(context).add(
                                DeleteOfferGroupEvent(Variable.offerGroupId??0));
                          },
                          gradient: const LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter,
                              colors:[ColorPalette.primary, ColorPalette.primary]),
                          child: Text(
